...
(
    ...
    CONSTRAINT FK_ORDER_DETAIL_STATUS_CODE FOREIGN KEY (ORDER_STATUS_CODE_ID) REFERENCES COMMON_CODE (ID) ON UPDATE CASCADE ON DELETE RESTRICT,
...
(
    ...
    CONSTRAINT FK_ORDER_DELIVERY_STATUS_CODE FOREIGN KEY (DELIVERY_STATUS_CODE_ID) REFERENCES COMMON_CODE (ID) ON UPDATE CASCADE ON DELETE RESTRICT,
...
(
    ...
    CONSTRAINT FK_ORDER_PAYMENT_DETAIL_METHOD FOREIGN KEY (PAYMENT_METHOD_CODE_ID) REFERENCES COMMON_CODE (ID) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT FK_ORDER_PAYMENT_DETAIL_STATUS FOREIGN KEY (ORDER_PAYMENT_STATUS_CODE_ID) REFERENCES COMMON_CODE (ID) ON UPDATE CASCADE ON DELETE RESTRICT,


    -- 데이터
    PAYMENT_AMOUNT               INT          NOT NULL COMMENT '결제 금액',
    PAYMENT_DATE                 DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6) COMMENT '결제 날짜 및 시간',
    COMMENT                      VARCHAR(255) NULL COMMENT '결제에 대한 추가 설명',
