...
(
    ...
    CONSTRAINT FK_OUTBOUND_DETAIL_MAIN FOREIGN KEY (OUTBOUND_MAIN_ID) REFERENCES OUTBOUND_MAIN (ID) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT FK_OUTBOUND_DETAIL_INBOUND FOREIGN KEY (INBOUND_DETAIL_ID) REFERENCES INBOUND_DETAIL (ID) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT FK_OUTBOUND_DETAIL_OUTBOUND FOREIGN KEY (OUTBOUND_CODE_ID) REFERENCES COMMON_CODE (ID) ON UPDATE CASCADE ON DELETE RESTRICT,
