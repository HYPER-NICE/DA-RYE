...
CREATE TABLE category (
                          id BIGINT AUTO_INCREMENT NOT NULL PRIMARY KEY COMMENT '카테고리 ID (기본 키)',
...
CREATE TABLE product (
                         id BIGINT AUTO_INCREMENT NOT NULL PRIMARY KEY COMMENT '제품 ID (기본 키)',
                         name VARCHAR(255) NOT NULL COMMENT '제품 이름',
                         description LONGTEXT NULL COMMENT '제품 설명',
...
CREATE TABLE inventory (
                           id BIGINT AUTO_INCREMENT NOT NULL PRIMARY KEY COMMENT '입고 ID (기본 키)',
