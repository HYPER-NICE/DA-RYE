...
(
    -- 기본키
    ID                  BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '주문 배송 상세 고유 ID (기본 키)',

    -- 외래키
    ORDER_DELIVERY_MAIN_ID BIGINT NOT NULL COMMENT '주문 배송 ID',
    CONSTRAINT FK_ORDER_DELIVERY_INFO_MAIN FOREIGN KEY (ORDER_DELIVERY_MAIN_ID) REFERENCES ORDER_DELIVERY_MAIN (ID) ON UPDATE CASCADE ON DELETE RESTRICT ,
