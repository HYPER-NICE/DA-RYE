...
(
    ...
    CODE        VARCHAR(255) NOT NULL COMMENT '상태 코드',
...
# CREATE TABLE P_CODE
# (
#     ID                          BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '상품 코드 ID (기본 키)',
#     IN_CODE_NAME                VARCHAR(255) NOT NULL UNIQUE COMMENT '입고 코드 이름',
#     IN_CODE_DESCRIPTION         VARCHAR(255) NULL COMMENT '입고 코드 설명',
#     OUT_CODE_NAME               VARCHAR(255) NOT NULL UNIQUE COMMENT '출고 코드 이름',
#     OUT_CODE_DESCRIPTION        VARCHAR(255) NULL COMMENT '출고 코드 설명',
#     P_STATUS_CODE_NAME          VARCHAR(255) NOT NULL UNIQUE COMMENT '상품 상태 코드 이름',
#     P_STATUS_CODE_DESCRIPTION   VARCHAR(255) NULL COMMENT '상품 상태 코드 설명'
# );
