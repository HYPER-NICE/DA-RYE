...
import { mockSubCategories } from '$lib/dummy/mockBoard.js';
...
export const actions = {
    ...
    // 인증 검사
		...
		const postNotificationUrl = new URL(`${SECRET_BACKEND_HOST}/api/notification-board`);

		try {
			const response = await fetch(postNotificationUrl, {
				method: 'POST',
